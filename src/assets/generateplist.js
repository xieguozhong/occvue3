import {fillLangString,htmlEscape,hextoBase64} from './comm'
export default class Generateplist {
    ...
    getACPI() {
        ...
        acpiContext += this.genArrayDict('ACPI_Patch', this.base.ACPI.Patch, ['Find', 'Mask', 'OemTableId', 'Replace', 'ReplaceMask', 'TableSignature'], ['BaseSkip', 'Count', 'Limit', 'Skip', 'TableLength']);
    ...
    getBooter() {
        ...
        if (this.base.configisMOD === false) {
            BooterContext += '<key>Quirks</key><dict>' + this.getStringorboolorinterger(this.clone(this.base.Booter.Quirks, ['EnableForAll']), thedt) + '</dict>';
        } else {
    ...
    getDeviceProperties() {
        ...
        DPContext += this.getDeviceData(this.getRewriteLRData('DeviceProperties_AddLeft', this.base.DeviceProperties.AddLeft), this.getRewriteLRData('DeviceProperties_AddRight', this.base.DeviceProperties.AddRight));

        //Delete
        DPContext += '<key>Delete</key>';
        DPContext += this.getDeviceVolumeData(this.getRewriteLRData('DeviceProperties_DeleteLeft', this.base.DeviceProperties.DeleteLeft), this.getRewriteLRData('DeviceProperties_DeleteRight', this.base.DeviceProperties.DeleteRight));
    ...
    getMisc() {
        ...
        let bodata = this.base.Misc.BlessOverride, bostring = '';
    ...
    getNVRAM() {
        ...
        nvramContext += this.getDeviceData(this.getRewriteLRData('NVRAM_AddLeft', this.base.NVRAM.AddLeft), this.getRewriteLRData('NVRAM_AddRight', this.base.NVRAM.AddRight));

        //2 Delete
        nvramContext += '<key>Delete</key>';
        nvramContext += this.getDeviceVolumeData(this.getRewriteLRData('NVRAM_DeleteLeft', this.base.NVRAM.DeleteLeft), this.getRewriteLRData('NVRAM_DeleteRight', this.base.NVRAM.DeleteRight));
        ...
        nvramContext += this.getDeviceVolumeData(this.getRewriteLRData('NVRAM_LegacySchemaLeft', this.base.NVRAM.LegacySchemaLeft), this.getRewriteLRData('NVRAM_LegacySchemaRight', this.base.NVRAM.LegacySchemaRight));
    ...
    getPlatformInfo() {
        let pfiContext = '<key>PlatformInfo</key><dict>', configisfull = this.base.configisfull;
        ...
        if (configisfull === true) {
            ...
            let thedt = {
                ARTFrequency: 'integer', BoardRevision: 'data', DevicePathsSupported: 'integer', FSBFrequency: 'integer', InitialTSC: 'integer', SmcBranch: 'data', SmcPlatform: 'data'
            ...
            let smbiosdatatype = {
                BoardType: 'integer', ChassisType: 'integer', FirmwareFeatures: 'data', FirmwareFeaturesMask: 'data',
    ...
    */
    ...
    rewriteData(leftdata, rightdata) {
        ...
        for (let i = 0; i < len; i++) {
            //console.log('leftdata[i] type = ' + getTypeof(leftdata[i]))
