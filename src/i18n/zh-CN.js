export default {
    ...
    lang: {
        ...
        toNumberError: '整形格式的数据被错误的输入了字符串"{0}", 可能导致配置文件错误, 请检查',
        ...
        Error: '错误',
        enabled: '启用/禁用',
        hexstringlengthisodd: '<{0}>不是有效的十六进制字符串, 因为十六进制字符串的长度不能为奇数',
        pleasecheckmessage: '请勾选需要的选项，然后点击 确定 按钮, 放弃请点击 关闭 按钮',
        editingtablemessage: '下列表格<br>{0}<br>正在编辑中,请在被编辑的文本框中按回车键保存更改或者按Esc键取消更改',
        ...
        plistformaterror: 'Plist文件格式错误, 没有找到名为 {0} 的节点数据'
    }
    , title: {
        ACPI: {
